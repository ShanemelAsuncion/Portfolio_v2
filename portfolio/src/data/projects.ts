...
export const projects: Project[] = [
  {
    ...
    images: [`${import.meta.env.BASE_URL}/1.png`, `${import.meta.env.BASE_URL}/2.png`, `${import.meta.env.BASE_URL}/5.png`, `${import.meta.env.BASE_URL}/3.png`, `${import.meta.env.BASE_URL}/4.png`],
  ...
  },
  {
    ...
    images: [`${import.meta.env.BASE_URL}/11.png`, `${import.meta.env.BASE_URL}/12.png`, `${import.meta.env.BASE_URL}/13.png`],
  ...
  },
  {
    ...
    images: [`${import.meta.env.BASE_URL}6.png`, `${import.meta.env.BASE_URL}7.png`, `${import.meta.env.BASE_URL}8.png`, `${import.meta.env.BASE_URL}9.png`, `${import.meta.env.BASE_URL}10.png`],
